...
// Hide the VU meter container by default
var vumeterContainer = document.getElementById('vumeterContainer');
vumeterContainer.style.display = 'none';

// Add event listener to the toggle switch
document.getElementById('vuMeterToggle').addEventListener('change', function () {
  var vuMeterToggle = document.getElementById('vuMeterToggle');

  if (vuMeterToggle.checked) {
    // Show the VU meter elements when checked
    vumeterContainer.style.display = 'block';
    startVUMeter(); // Start the VU meter
  } else {
    // Hide the VU meter elements when unchecked
    vumeterContainer.style.display = 'none';
    stopVUMeter(); // Stop the VU meter
  }
});
